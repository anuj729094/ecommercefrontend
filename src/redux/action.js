export const gettshirt = (category) => async (dispatch) => {
  try {
    ...
    const data = await fetch(`https://patric-ecommercebackend.vercel.app/getproduct/${category}`, {
      method: 'GET',
      headers: {
...
export const getitembycategory = (data2) => async (dispatch) => {
  try {
    ...
    const data = await fetch('https://patric-ecommercebackend.vercel.app/getitem', {
      method: 'POST',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json'
...
export const getitembyid = (productid) => async (dispatch) => {
  try {
    ...
    const data = await fetch('https://patric-ecommercebackend.vercel.app/getitembyproductid', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
export const additem = (data2) => async (dispatch) => {
  try {
    ...
    const data = await fetch('https://patric-ecommercebackend.vercel.app/additem', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
export const getcartitem = (email) => async (dispatch) => {
  try {
    ...
    const data = await fetch(`https://patric-ecommercebackend.vercel.app/getcartitem/${email}`, {
      method: 'GET',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json'
...
export const removecartitem = (id) => async (dispatch) => {
  try {
    const data = await fetch(`https://patric-ecommercebackend.vercel.app/removecartitem/${id}`, {
      method: 'GET',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json'
...
export const addminus = (data2) => async (dispatch) => {
  try {
    ...
    const data = await fetch('https://patric-ecommercebackend.vercel.app/indec', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
export const payment = (data2) => async (dispatch) => {
  try {
    ...
    const datap = await fetch('https://patric-ecommercebackend.vercel.app/key', {
      method: 'GET',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json'
    ...
    if (resp) {
      ...
      const data = await fetch(`https://patric-ecommercebackend.vercel.app/price/${checkout}`, {
        method: 'GET',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json'
      ...
      if (res) {
        const options = {
          ...
          handler: async function (response) {
            ...
            const datat = await fetch('https://patric-ecommercebackend.vercel.app/payment', {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json'
              },
            ...
            if (res.message === 'payment successful') {
              ...
              const datar = await fetch('https://patric-ecommercebackend.vercel.app/order', {
                method: 'POST',
                headers: {
                  'Content-Type': 'application/json'
                },
...
export const getsearchitem = (search) => async (dispatch) => {
  try {
    ...
    const data = await fetch('https://patric-ecommercebackend.vercel.app/getsearch', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
export const getorder = (email)=>async(dispatch)=>{
  try {
    ...
    const data = await fetch(`https://patric-ecommercebackend.vercel.app/getorder/${email}`,{
      method:'GET',
      headers:{
        Accept:'application/json',
        'Content-Type':'application/json'
...
export const addtowish = (data2)=>async(dispatch)=>{
  try {
    ...
    const data = await fetch('https://patric-ecommercebackend.vercel.app/wish',{
      method:'POST',
      headers:{
        'Content-Type':'application/json'
      },
...
export const getwish = (email) => async (dispatch) => {
  try {
    ...
    const data = await fetch(`https://patric-ecommercebackend.vercel.app/getwish/${email}`, {
      method: 'GET',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json'
...
export const getwishcount = (email) => async (dispatch) => {
  try {
    ...
    const data = await fetch(`https://patric-ecommercebackend.vercel.app/getwishcount/${email}`, {
      method: 'GET',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json'
...
export const removewish = (id)=>async(dispatch)=>{
   try {
     const data = await fetch(`https://patric-ecommercebackend.vercel.app/removewish/${id}` , {
      method:'GET',
      headers:{
        Accept:'application/json',
        'Content-Type':'application/json'
